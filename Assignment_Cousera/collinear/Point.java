...
public class Point implements Comparable<Point> {
    ...
    public Comparator<Point> slopeOrder() {
        ...
        Comparator<Point> SLOPE_ORDER = new Comparator<Point>() {
    ...
    public static void main(String[] args) {
        ...
        StdDraw.setXscale(-1000, 25000);
        StdDraw.setYscale(-1000, 25000);
        StdDraw.line(-1000, 0, 25000, 0);
        StdDraw.line(0, -1000, 0, 25000);
        ...
        for (int i = 0; i < n; i++) {
            ...
            StdDraw.text(x, 10, "" + x, 90);
            // StdDraw.line(-500, y, 0, y);
            StdDraw.text(10, y, "" + y);
            array[i].draw();
        }
        StdDraw.show();
        ...
        Arrays.sort(array, array[2].slopeOrder());
        for (int i = 0; i < n; i++) {
            StdOut.println(array[i]);
        }
        /* YOUR CODE HERE */
